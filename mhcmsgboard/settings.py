"""
Django settings for mhcmsgboard project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'boards.context_processors.get_categories',
            ],
        },
    },
]

WSGI_APPLICATION = 'mhcmsgboard.wsgi.application'
...
# Crispy forms template pack for Bootstrap
